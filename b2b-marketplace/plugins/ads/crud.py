...
# Ad CRUD Operations
def create_ad(db: Session, ad_data: AdCreate, seller_id: int, new_seller_id: str = None) -> Ad:
    """Create a new advertisement"""
    db_ad = Ad(
        seller_id=seller_id, new_seller_id=new_seller_id,
        title=ad_data.title,
...
def get_seller_ads(
    ...
    query = db.query(Ad).filter(Ad.new_seller_id == new_seller_id if new_seller_id else Ad.seller_id == seller_id)
...
def create_campaign(db: Session, campaign_data: AdCampaignCreate, seller_id: int, new_seller_id: str = None) -> AdCampaign:
...
def get_seller_campaigns(
    ...
    query = db.query(AdCampaign).filter(AdCampaign.new_seller_id == new_seller_id if new_seller_id else AdCampaign.seller_id == seller_id)
...
def get_seller_ad_performance(
    ...
    ads = db.query(Ad).filter(
        Ad.new_seller_id == new_seller_id if new_seller_id else Ad.seller_id == seller_id,
