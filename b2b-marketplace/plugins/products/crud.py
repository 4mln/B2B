...
# Create Product
# -----------------------------
async def create_product(db: AsyncSession, product: ProductCreate, seller_id: int, new_seller_id: str = None) -> Product:
...
# Update Product
# -----------------------------
async def update_product(db: AsyncSession, product_id: int, product_data: ProductUpdate, seller_id: int, new_seller_id: str | None = None) -> Optional[Product]:
...
# Delete Product
# -----------------------------
async def delete_product(db: AsyncSession, product_id: int, seller_id: int, new_seller_id: str | None = None) -> bool:
    db_product = await db.get(Product, product_id)
    if not db_product or db_product.seller_id != seller_id:
        return False
