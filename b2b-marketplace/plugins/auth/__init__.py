...
class Plugin(PluginBase):
    ...
    def register_routes(self, app: FastAPI):
        ...
        # Mount at both /auth and /api/v1/auth
        app.include_router(routes.router, prefix=f"/{self.slug}", tags=["Auth"]) 
        app.include_router(routes.router, prefix=f"/api/v1/{self.slug}", tags=["Auth"]) 
